...
- Published v0.3.39 build ID: `08e2b0182796eded`; current unreleased build ID: `64ea246abd086f70`.
- Legacy composition-root ratchet: 3,431 lines and two module-level shared declarators.
...
- `src/legacy/runtime.js` remains a 3,431-line composition root.
